...
//    private double yPosition;
//    
//    public Ball(Sprite sprite, int x, int y, Main ps) {
//        super(sprite, x, y, ps);
//        this.ps = ps;
//        this.canMove = true;
//        
...
//            this.directionY *= -1;
//        }
//        else if ((super.position.y + this.getSprite().getImage().getWidth()) > Main.MAP_HEIGHT) {
//            this.directionY *= -1; 
//        }
//        // toto je jen kolize s pravou stranou, od te se nebude odrazet
//        else if ((super.position.x + this.getSprite().getImage().getHeight()) > Main.MAP_WIDTH) {
//            this.directionX *= -1;
